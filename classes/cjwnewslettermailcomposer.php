...
/**
 *  new Class CjwNewsletterMailComposer because auf imageInclude problem of ezcMailComposer ezcomponents 1.7.1
 *  http://issues.ez.no/IssueView.php?Id=16612&
 *
 *  and implementing new feature - only include files which are in ezroot
 *
 *  <img src="file://ezroot/extension...image_abcd.png" border="0" width="640" height="109" alt="">
 *
 * ezcMailComposer class description with some modifications in examples:
 *
 ...
 * </code>
 *
 * By default, if the htmlText property contains an HTML image tag with file://ezroot/
 * in href, that file will be included in the created message.
 *
 * CJW Newsletter changes: only includes images from ezroot
 *
 * Example:
 * <code>
 * <img src="file://ezroot/extension/my_design/design/standard/images/image.jpg" />
 * </code>
 *
 ...
 * @mainclass
 */
class CjwNewsletterMailComposer extends ezcMail
{
    /**
