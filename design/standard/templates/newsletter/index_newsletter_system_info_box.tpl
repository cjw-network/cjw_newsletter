<div class="block">
    ...
    <table cellspacing="0" cellpadding="0" class="list">
        ...
        {foreach $newsletter_list_node_list as $newsletter_list_node sequence array( 'bglight', 'bgdark' ) as $style}
            ...
            <tr class="{$style}">
                <td width="61%" align="left">{'cjw_newsletter_list'|class_icon( 'small' )} <a href={$newsletter_list_node.url_alias|ezurl}>{$newsletter_list_node.name|wash()} / {$newsletter_list_node.data_map.title.content|wash()}</a></td>
