...
CREATE TABLE cjwnl_edition_send (
  ...
  status tinyint(4) NOT NULL COMMENT '0- WAIT_FOR_PROCESS, 1 - MAILQUEUE_CREATED, 2 - MAILQUEUE_PROCESS_STARTED, 3 - MAILQUEUE_PROCESS_FINISHED, 9 - ABORT',
...
CREATE TABLE cjwnl_edition_send_item (
  ...
  newsletter_user_id int(11) NOT NULL,
  output_format_id tinyint(4) NOT NULL,
  subscription_id int(11) NOT NULL,
  created int(11) NOT NULL COMMENT 'timestamp',
  processed int(11) NOT NULL COMMENT 'timestamp',
  status tinyint(4) NOT NULL COMMENT '0 - NEW, 1 - SEND, 9 - ABBORT ',
  hash varchar(255) NOT NULL,
